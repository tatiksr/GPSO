...
public class GPSOT_1430 extends Project {

		@BeforeTest

		public void setData() {
			testCaseName = "GPSOT_1430";
			testCaseDesc = "SF Update Profile - Onboarding Plan Services";
			category = "GPSOTest";
			author = "Suraj";
		...
		public void GPSOT_1425_New_Test(Map<String, String> details) throws InterruptedException, IOException {
			...
			try {
				...
				try {
					...
					Thread.sleep(5000);	
					click(locateElement("xpath", "//a[text()='US Onboarding Plan Service']"));
					Thread.sleep(5000);	
					driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@title='Profile: US Onboarding Plan Service ~ Salesforce - Unlimited Edition']")));
				/*	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
			          ...
			          locateElement("xpath", "//th[text()='Accounts']//parent::tr//child::table/tbody[1]/tr[1]/td/img[@id='crudRead___Account']").isSelected();
						locateElement("xpath", "//img[@id='crudRead___Contact']").isSelected();
						 Actions actions=new Actions(driver); 
				          actions.click(locateElement("xpath", "//h3[text()='External Object Permissions']"));
				         /* locateElement("xpath", "//th[text()='Accounts']//parent::tr//child::table/tbody[1]/tr[1]/td/img[@id='crudRead___Account']").isSelected();
							locateElement("xpath", "//img[@id='crudRead___Contact']").isSelected();*/
